...
class View {
    ...
    constructor (initalModel: Model, shadowRoot) {
        this.output = shadowRoot.getElementById('output');

        shadowRoot.getElementById('incBtn').addEventListener('click', () => {
            window.dispatchEvent(new Event('increment counter'));
        });

        shadowRoot.getElementById('decBtn').addEventListener('click', () => {
...
class Controller {
    constructor (shadowRoot) {
        ...
        const view = new View(model, shadowRoot);
