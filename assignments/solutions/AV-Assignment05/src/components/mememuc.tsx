...
const OmmMemeMUC: React.FC = () => {
    ...
    function saveFavorites() {
        let newMeme: Meme = {
            ...
            link: selectState?.link!
        }

        let customMeme: CustomizedMeme = {
            baseMeme: newMeme!,
        ...
        setSavedMemes(savedMemes => [...savedMemes, customMeme])

        console.log("Custom meme is: ", customMeme)
    }
    ...
    return (<div className="mememuc">
        <ul className="meme-list">{
            memeState.map((meme) => {
                return (<li key={meme.link} onClick={() => {
                    setSelectState(meme)
                }}>
        ...
        <div className="params">
            <div className="texts">
                <input name="topText" value={captionState.topText} onChange={captionChanged} type="text"
                       placeholder="Upper Text"/>
                <input name="bottomText" value={captionState.bottomText} onChange={captionChanged} type="text"
            ...
            <input type="button" value="Save to favorites" className="save-fav" onClick={saveFavorites}></input>
        </div>
        <OmmMemeMUCHistory savedMemes={savedMemes}
                           deleteMeme={(key: any) => {
